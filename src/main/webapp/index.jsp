...
<meta name="description" content="四川省 邛崃市云联惠" />
	...
	<script type="text/javascript">
	 	window.onload = function(){
	 		...
	 		if(obj.value!=1){
	 			location.href="selectIndexCategory.action";
	 		} */
	 	}
                    ...
                    <li>
                        ...
                        <div class="zj">
                            <div class="zj_l">
                                <div class="zj_l_c">
                                    <h2>零食 / 糖果 / 巧克力</h2>
                                    <a href="pages/CategoryList.jsp">坚果</a>|<a href="#">蜜饯</a>|<a href="#">红枣</a>|<a href="#">牛肉干</a>|<a href="#">巧克力</a>|
...
<div class="i_bg bg_color">
	<div class="i_ban_bg">
        ...
        <div class="inews">
            ...
            <ul>
            	<li><span>[ 公告 ]</span>欢迎商家入驻</li>
            	<li><span>[ 公告 ]</span>请联系我们</li>
            	<li><span>[ 公告 ]</span>400-400-400</li>
            	<li><span>[ 公告 ]</span></li>
            	<li><span>[ 公告 ]</span></li>
            </ul>
        </div>
    ...
    <div class="content">
    	<div class="i_sell">
            <div id="imgPlay">
                <ul class="imgs" id="actor">
                    <li><a href="#"><img src="Picture/tm_r.jpg" width="211" height="357" /></a></li>
                    <li><a href="#"><img src="Picture/tm_r.jpg" width="211" height="357" /></a></li>
                    <li><a href="#"><img src="Picture/tm_r.jpg" width="211" height="357" /></a></li>
                </ul>
        ...
        <div class="sell_right">
        	<div class="sell_1">
            	<div class="s_img"><a href="pages/Details.jsp"><img src="Picture/tm_1.jpg" width="185" height="155" /></a></div>
            	<div class="s_price"><span></span></div>
                <div class="s_name">
                	<h3><a href="pages/Details.jsp">点我进入商家详情</a></h3>
                </div>
            </div>
            <div class="sell_2">
            	<div class="s_img"><a href="#"><img src="Picture/tm_2.jpg" width="185" height="155" /></a></div>
            	<div class="s_price"><span></span></div>
                <div class="s_name">
                	<h3><a href="#">zzzzzzzzzzzzzzzzzzzzzz2</a></h3>
                </div>
            </div>
            <div class="sell_b1">
            	<div class="sb_img"><a href="#"><img src="Picture/tm_b1.jpg" width="242" height="356" /></a></div>
            	<div class="s_price"><span></span></div>
                <div class="s_name">
                	<h3><a href="#">zzzzzzzzzzzzzzzzzzzzzz3</a></h3>
                </div>
            </div>
            <div class="sell_3">
            	<div class="s_img"><a href="#"><img src="Picture/tm_3.jpg" width="185" height="155" /></a></div>
            	<div class="s_price"><span></span></div>
                <div class="s_name">
                	<h3><a href="#">zzzzzzzzzzzzzzzzzzzzzz4</a></h3>
                </div>
            </div>
            <div class="sell_4">
            	<div class="s_img"><a href="#"><img src="Picture/tm_4.jpg" width="185" height="155" /></a></div>
            	<div class="s_price"><span></span></div>
                <div class="s_name">
                	<h3><a href="#">zzzzzzzzzzzzzzzzzzzzzz5</a></h3>
                </div>
            </div>
            <div class="sell_b2">
            	<div class="sb_img"><a href="#"><img src="Picture/tm_b2.jpg" width="242" height="356" /></a></div>
            	<div class="s_price"><span></span></div>
                <div class="s_name">
                	<h3><a href="#">zzzzzzzzzzzzzzzzzzzzzz6</a></h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="content mar_20">
    	<img src="Picture/mban_1.jpg" width="1200" height="110" />
    </div>
    ...
    <div class="content">
        	...
        	<div class="fre_ban">
            	<div id="imgPlay1">
                    <ul class="imgs" id="actor1">
                        <li><a href="#"><img src="Picture/fre_r.jpg" width="211" height="286" /></a></li>
                        <li><a href="#"><img src="Picture/fre_r.jpg" width="211" height="286" /></a></li>
                        <li><a href="#"><img src="Picture/fre_r.jpg" width="211" height="286" /></a></li>
                    </ul>
        ...
        <div class="fresh_mid">
        	<ul>
            	<li>
                	<div class="name"><a href="#">商家名字1</a></div>
                    <div class="price">
                    </div>
                    <div class="img"><a href="#"><img src="Picture/fre_1.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">商家名字1</a></div>
                    <div class="price">
        	...
        	<div class="food_ban">
            	<div id="imgPlay2">
                    <ul class="imgs" id="actor2">
                        <li><a href="#"><img src="Picture/food_r.jpg" width="211" height="286" /></a></li>
                        <li><a href="#"><img src="Picture/food_r.jpg" width="211" height="286" /></a></li>
                        <li><a href="#"><img src="Picture/food_r.jpg" width="211" height="286" /></a></li>
                    </ul>
        ...
        <div class="fresh_mid">
        	<ul>
            	<li>
                    ...
                    <div class="img"><a href="#"><img src="Picture/food_1.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">莫斯利安酸奶</a></div>
                    <div class="price">
                    </div>
                    <div class="img"><a href="#"><img src="Picture/food_2.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">莫斯利安酸奶</a></div>
                    <div class="price">
                    </div>
                    <div class="img"><a href="#"><img src="Picture/food_3.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">莫斯利安酸奶</a></div>
                    <div class="price">
                    </div>
                    <div class="img"><a href="#"><img src="Picture/food_4.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">莫斯利安酸奶</a></div>
                    <div class="price">
                    </div>
                    <div class="img"><a href="#"><img src="Picture/food_5.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">莫斯利安酸奶</a></div>
                    <div class="price">
                    </div>
                    <div class="img"><a href="#"><img src="Picture/food_6.jpg" width="185" height="155" /></a></div>
                </li>
            </ul>
        </div>
        	...
        	<div class="make_ban">
            	<div id="imgPlay3">
                    <ul class="imgs" id="actor3">
                        <li><a href="#"><img src="Picture/make_r.jpg" width="211" height="286" /></a></li>
                        <li><a href="#"><img src="Picture/make_r.jpg" width="211" height="286" /></a></li>
                        <li><a href="#"><img src="Picture/make_r.jpg" width="211" height="286" /></a></li>
                    </ul>
        ...
        <div class="fresh_mid">
        	<ul>
            	<li>
                    ...
                    <div class="img"><a href="#"><img src="Picture/make_1.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">美宝莲粉饼</a></div>
                    <div class="price">
                    </div>
                    <div class="img"><a href="#"><img src="Picture/make_2.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">美宝莲粉饼</a></div>
                    <div class="price">
                    </div>
                    <div class="img"><a href="#"><img src="Picture/make_3.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">美宝莲粉饼</a></div>
                    <div class="price">
                    </div>
                    <div class="img"><a href="#"><img src="Picture/make_4.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">美宝莲粉饼</a></div>
                    <div class="price">
                    </div>
                    <div class="img"><a href="#"><img src="Picture/make_5.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">美宝莲粉饼</a></div>
                    <div class="price">
                    </div>
                    <div class="img"><a href="#"><img src="Picture/make_6.jpg" width="185" height="155" /></a></div>
                </li>
            </ul>
        </div>
                    ...
                    <div id="botton-scroll1">
                        <ul class="featureUL">
                            <li class="featureBox">
                                <div class="box">
                                    <div class="imgbg">
                                        <a href="#"><img src="Picture/hot1.jpg" width="160" height="136" /></a>
                                    </div>                                        
                                    <div class="name">
                                        <a href="#">
                                        <h2>德国进口</h2>
